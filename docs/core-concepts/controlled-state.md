...
|---------|---------|---------------|-------------|
| **Controlled** | `v-model="ref"` | — | You need to read, watch, or set the value |
| **Uncontrolled** | — | `:default-value="'initial'"` | Self-contained select, value read at form submit |
...
- [Basic Select](/recipes/basic-select) — build complete select patterns
